 ...
 * @author cwolfgang
 */
public class JENKINS18278InterprojectIT extends JENKINS18278BaseIT {

    private static final Logger logger = Logger.getLogger(JENKINS18278InterprojectIT.class.getName() );
