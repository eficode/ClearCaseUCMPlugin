...
public class Polling extends CCUCMTestCase {
	...
	public void testPollingSelfWithBaselines() throws Exception {
		...
		FreeStyleProject project = setupProject( "polling-test-with-baselines-" + un, "self", "one_int@" + coolTest.getPVob(), false, false, false );
	...
	public void testPollingSelfWithNoBaselines() throws Exception {
		String un = setupCC( false );
		FreeStyleProject project = setupProject( "polling-test-with-baselines-" + un, "self", "one_dev@" + coolTest.getPVob(), false, false, false );
